...
const CreateStore = () => {
  ...
  return ( <
    ...
    onChange = {
      (e) => {
        formChange(e, 'shopAddress')
      }
    }
    /> <
    /Form.Item> <
    Form.Item label = "品牌门头" >
    <
    PicturesWall fileImgs = {
      fileImgs
    }
    getFileListData = {
      getFileListData
